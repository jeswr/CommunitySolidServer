...
/**
 * Runs the given function within a logging context that has a request identifier.
 ...
 * @param id - The identifier to use for the context. A new one is generated when omitted.
 *
 * @returns The result of calling the given function.
 */
export function runWithRequestId<T>(fn: () => T, id: string = randomUUID()): T {
